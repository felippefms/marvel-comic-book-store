...
function GetHq(){
    ...
    const [itemsPerPage] = useState(12) //State para pegar determinada quantia de items para exibir por pagina.
    ...
    useEffect(() => {
      ...
      const apiUrl = `https://gateway.marvel.com/v1/public/comics?ts=${timeStamp}&apikey=${publicKey}&hash=${hash}&limit=92&orderBy=title`;
